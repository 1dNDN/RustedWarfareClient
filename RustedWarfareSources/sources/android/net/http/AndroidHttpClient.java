...
public final class AndroidHttpClient implements HttpClient {
    ...
    private static final HttpRequestInterceptor f252c = new HttpRequestInterceptor() { // from class: android.net.http.AndroidHttpClient.1
        public void process(HttpRequest httpRequest, HttpContext httpContext) {
            if (Looper.m4970d() != null && Looper.m4970d() == Looper.m4972b()) {
    ...
    /* renamed from: a */
    public static AndroidHttpClient m4995a(String str, Context context) {
    ...
    /* renamed from: a */
    public static AndroidHttpClient m4996a(String str) {
        return m4995a(str, (Context) null);
    }
    ...
    protected void finalize() {
        super.finalize();
        if (this.f254e != null) {
            Log.m4936b("AndroidHttpClient", "Leak found", this.f254e);
            this.f254e = null;
        }
    }
    ...
    /* renamed from: b */
    public static String m4991b(HttpUriRequest httpUriRequest, boolean z) {
        Header[] allHeaders;
        HttpEntity entity;
    ...
    /* renamed from: a */
    private static boolean m4994a(HttpUriRequest httpUriRequest) {
