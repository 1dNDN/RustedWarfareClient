...
public final class AssetManager {
    ...
    /* renamed from: a */
    public final InputStream m5159a(String str) {
        return m5158a(str, 2);
    }

    /* renamed from: a */
    public final InputStream m5158a(String str, int i) {
    ...
    /* renamed from: b */
    public final AssetFileDescriptor m5156b(String str) {
        synchronized (this) {
            if (!this.f121e) {
                throw new RuntimeException("Assetmanager has been closed");
            }
    ...
    /* renamed from: c */
    public final String[] m5154c(String str) {
        return new String[0];
    }
    ...
    /* renamed from: a */
    private final void m5164a() {
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: a */
    public final void m5163a(int i) {
        this.f120d--;
        if (this.f120d == 0) {
            m5164a();
        }
