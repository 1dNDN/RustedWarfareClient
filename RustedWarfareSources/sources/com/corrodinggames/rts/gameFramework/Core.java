...
public abstract class Core {
    ...
    /* renamed from: bQ */
    public SettingsEngine settingEngine;
    ...
    /* renamed from: al */
    protected static Core f6189al = null;
    ...
    /* renamed from: dC */
    final Handler f6276dC = new Handler(Looper.m5360b());

    /* renamed from: a */
    private Runnable f6277a = new Runnable() { // from class: com.corrodinggames.rts.gameFramework.l.1
        @Override // java.lang.Runnable
        public void run() {
            String str = Core.this.f6172dD;
            try {
                if (str == null) {
                    Core.m983b("Cannot show toast, no message");
                } else {
                    Toast.makeText(Core.this.f6227am, str, 1).show();
                }
            } catch (Exception e) {
                Core.m983b("Error showing toast: " + ((Object) str));
                e.printStackTrace();
            }
        }
    };
    ...
    private Runnable f6278b = new Runnable() { // from class: com.corrodinggames.rts.gameFramework.l.2
        ...
        public void run() {
            ...
            Core.LogDebug2("showMessageBoxRunnable context:" + Core.this.f6227am.getClass().getName());
            try {
                new AlertDialog.Builder(Core.this.f6227am).setIcon(17301543).setTitle(Core.this.f6173dE).setMessage(Core.this.f6174dF).setOnCancelListener(onCancelListener).setPositiveButton("Ok", onClickListener).show();
            } catch (WindowManager.BadTokenException e) {
                Core.m983b("Failed to show message: " + Core.this.f6174dF);
                e.printStackTrace();
            }
        }
    };
    ...
    /* renamed from: c */
    private boolean[] f6284c = new boolean[KeyEvent.m5309a() + 1];

    /* renamed from: d */
    private boolean[] f6285d = new boolean[KeyEvent.m5309a() + 1];
    ...
    /* renamed from: a */
    public abstract void m1038a(Context context);

    /* renamed from: a */
    public abstract boolean m1046a();

    /* renamed from: a */
    public abstract boolean m1023a(boolean z);

    /* renamed from: a */
    public abstract void m1039a(Activity activity, InterfaceC0096f interfaceC0096f, boolean z);

    /* renamed from: b */
    public abstract void m986b(int i, int i2);

    /* renamed from: c */
    public abstract int m973c(boolean z);

    /* renamed from: m */
    public abstract boolean m946m();

    /* renamed from: o */
    public abstract boolean m943o();

    /* renamed from: k */
    public abstract String m951k();

    /* renamed from: l */
    public abstract String m948l();

    /* renamed from: q */
    public abstract String m940q();

    /* renamed from: s */
    public abstract String m938s();

    /* renamed from: t */
    public abstract String m937t();

    /* renamed from: r */
    public abstract void m939r();

    /* renamed from: u */
    public abstract String m936u();

    /* renamed from: a */
    public abstract void m1021a(boolean z, boolean z2, EnumC1063s enumC1063s);

    /* renamed from: a */
    public abstract void m1022a(boolean z, EnumC1063s enumC1063s);

    /* renamed from: e */
    public abstract void m967e();

    /* renamed from: w */
    public abstract void m935w();

    /* renamed from: a */
    public abstract void m1043a(float f, int i);

    /* renamed from: y */
    public abstract int m934y();

    /* renamed from: b */
    public abstract int m989b();

    /* renamed from: c */
    public abstract boolean m980c();

    /* renamed from: d */
    public abstract boolean m972d();

    /* renamed from: b */
    public static boolean m984b(Context context) {
        String mo5555h;
        if (f6205aU) {
            mo5555h = "dedicatedServer";
        } else {
            mo5555h = context.mo5556g().mo5555h();
        }
        Log.m5321d("RustedWarfare", "packageName:" + mo5555h);
        if (mo5555h.contains("rtsdemo")) {
            return true;
        }
        return false;
    }
    ...
    /* renamed from: z */
    public boolean m933z() {
        return this.f6159cR || this.f6160cS > 0.0f || this.f6161cT;
    }

    /* renamed from: A */
    public static final Core m1072A() {
        return f6189al;
    }

    /* renamed from: B */
    public static final boolean m1071B() {
        return f6215be;
    }

    /* renamed from: C */
    public static final boolean m1070C() {
        return f6216bf;
    }

    /* renamed from: c */
    public void m977c(Context context) {
        C0090c.m5194a(context);
        this.f6227am = context;
    }

    /* renamed from: a */
    public static synchronized Core m1037a(Context context, AbstractC1057n abstractC1057n) {
        if (f6189al != null) {
            if (abstractC1057n != null) {
                f6189al.f6279dG = abstractC1057n;
            }
            f6189al.m977c(context);
            return f6189al;
        }
        f6189al = f6217dx.mo448a(context);
        LogDebug2("Created new gameEngine of:" + f6189al.getClass().getName());
        if (abstractC1057n != null) {
            f6189al.f6279dG = abstractC1057n;
        }
        f6189al.m1038a(context);
        return f6189al;
    }

    public Core(Context context) {
        Log.m5321d("RustedWarfare", "GameEngine:GameEngine()");
        if (f6189al != null) {
    ...
    protected void finalize() {
        Log.m5321d("RustedWarfare", "GameEngine:finalize()");
        super.finalize();
    }
    ...
    /* renamed from: F */
    public String m1067F() {
        if (m995au()) {
            return "PC";
        }
        if (f6210aZ) {
            String m1082a = C0913a.m1082a();
            if (m1082a != null) {
                return "IOS - " + m1082a;
            }
            return "IOS";
    ...
    /* renamed from: G */
    public String m1066G() {
        return f6218dy;
    }

    /* renamed from: H */
    public boolean m1065H() {
        if (this.f6243bH) {
            return true;
        }
        return false;
    ...
    /* renamed from: I */
    public synchronized void m1064I() {
        ...
        if (!f6207aW && !f6212bb && this.f6266dj == null) {
            ...
            this.f6266dj.m415a(true);
            this.f6266dj.start();
        }
    }

    /* renamed from: J */
    public synchronized void m1063J() {
    ...
    /* renamed from: K */
    public synchronized void m1062K() {
        LogDebug2("--- setStopped ---");
        if (this.f6266dj == null) {
            Log.m5321d("RustedWarfare", "gameThread already null");
            return;
        }
        if (!m995au()) {
            this.f6112bN.m2650f();
        }
        this.f6266dj.m415a(false);
        if (Thread.currentThread() != this.f6266dj) {
            boolean z = true;
            while (z) {
                try {
            ...
            Log.m5321d("RustedWarfare", "thread stop");
        } else {
            m958g("currentThread is game thread");
        }
        this.f6266dj = null;
    ...
    public boolean m1061L() {
        if (this.f6122bX == null || !this.f6122bX.lock1 || this.f6122bX.f5571F || this.f6126cb.m2411h()) {
            return false;
        }
        return true;
    }
    ...
    /* renamed from: N */
    public boolean m1059N() {
        if (this.f6122bX == null) {
            return false;
        }
        return this.f6122bX.f5571F || this.f6122bX.lock1 || this.f6126cb.m2411h();
    }

    /* renamed from: O */
    public boolean m1058O() {
        if (this.f6122bX == null || this.f6122bX.f5571F) {
            return true;
        }
        return (this.f6122bX.lock1 || this.f6126cb.m2411h()) ? false : true;
    }
    ...
    public void m1057P() {
        ...
        if (this.f6110bL != null) {
            if (this.f6146cx > this.f6110bL.m4853i() - this.f6152cD) {
                this.f6146cx = this.f6110bL.m4853i() - this.f6152cD;
                this.f6141cs = true;
            }
            if (this.f6147cy > this.f6110bL.m4852j() - this.f6149cA) {
                this.f6147cy = this.f6110bL.m4852j() - this.f6149cA;
                this.f6141cs = true;
            }
            if (this.f6152cD > this.f6110bL.m4853i()) {
                this.f6146cx = (this.f6110bL.m4853i() / 2.0f) - (this.f6152cD / 2.0f);
                this.f6141cs = true;
            }
            if (this.f6149cA > this.f6110bL.m4852j()) {
                this.f6147cy = (this.f6110bL.m4852j() / 2.0f) - (this.f6149cA / 2.0f);
                this.f6141cs = true;
            }
        }
        m1045a(this.f6146cx, this.f6147cy);
    }

    /* renamed from: a */
    public void m1045a(float f, float f2) {
        this.f6146cx = f;
        this.f6147cy = f2;
        ...
        this.f6250cM.m5423a((int) (this.f6146cx - i), (int) (this.f6147cy - i), (int) (this.f6146cx + this.f6148cz + i), (int) (this.f6147cy + this.f6149cA + i));
        this.f6251cN.m5409a(this.f6250cM);
        this.f6253cP.m5423a((int) this.f6146cx, (int) this.f6147cy, (int) (this.f6146cx + this.f6148cz), (int) (this.f6147cy + this.f6149cA));
        this.f6252cO.m5410a((int) (this.f6146cx - 300), (int) (this.f6147cy - 300), (int) (this.f6146cx + this.f6148cz + 300), (int) (this.f6147cy + this.f6149cA + 300));
    }

    /* renamed from: b */
    public void m988b(float f, float f2) {
        m1045a(f - (this.f6152cD / 2.0f), f2 - (this.f6149cA / 2.0f));
    }

    /* renamed from: d */
    public static boolean m970d(Context context) {
        if (f6205aU) {
            return false;
        }
        if (Build.MODEL.equals("GT-I9100") || Build.MODEL.equals("GT-I9300")) {
            try {
                WifiInfo connectionInfo = ((WifiManager) context.mo5560c("wifi")).getConnectionInfo();
    ...
    public void m1056Q() {
        if (this.f6256cW != 1.0f) {
            this.f6113bO.mo228a(this.f6256cW, this.f6256cW);
        }
    }
    ...
    public void m1055R() {
        if (this.f6256cW != 1.0f) {
            this.f6113bO.mo228a(1.0f / this.f6256cW, 1.0f / this.f6256cW);
        }
    }

    /* renamed from: a */
    public static void m1028a(String str, Exception exc) {
        LogDebug2(str);
        exc.printStackTrace();
    }

    /* renamed from: a */
    public static String m1027a(String str, String str2) {
    ...
    /* renamed from: a */
    public static void m1031a(String str) {
        LogDebug2(m1027a("--- ERROR: " + str, "\u001b[31m"));
    }

    /* renamed from: b */
    public static void m983b(String str) {
        LogDebug2(m1027a(str, "\u001b[33m"));
    }

    /* renamed from: a */
    public static void m1026a(String str, Throwable th) {
        m983b(str);
    ...
    /* renamed from: d */
    public static void m969d(String str) {
        LogDebug(str);
    }
    ...
    /* renamed from: b */
    public static void m982b(String str, String str2) {
        LogDebug(str + ":" + str2);
    }

    /* renamed from: f */
    public static synchronized void m961f(String str) {
        LogDebug(str + " (at " + System.nanoTime() + ")");
    }

    /* renamed from: S */
    public static void m1054S() {
    ...
    /* renamed from: g */
    public static void m958g(String str) {
        m983b(str);
        m1054S();
    }

    /* renamed from: U */
    public static long m1052U() {
        return System.currentTimeMillis();
    }

    /* renamed from: a */
    public static final boolean m1040a(long j, long j2) {
        long m1052U = m1052U();
        if (j + j2 < m1052U || m1052U < j - 1000) {
            return true;
        }
        return false;
    }
    ...
    public float m1051V() {
        ...
        if (this.settingEngine != null) {
            f = f * this.settingEngine.renderDensity * this.settingEngine.uiRenderScale;
            if (this.settingEngine.renderDoubleScale) {
                return f / 2.0f;
            }
        }
        return f;
    ...
    /* renamed from: e */
    public int m966e(float f) {
        return (int) ((f * this.f6132ci) + 0.5f);
    }

    /* renamed from: a */
    public int m1042a(int i) {
    ...
    public void m1049X() {
        Iterator it = this.f6275dB.iterator();
        while (it.hasNext()) {
            this.f6113bO.mo213a(((C1029m) it.next()).f6595b);
        }
        this.f6274dA = true;
    }

    /* renamed from: a */
    public void m1036a(Paint paint) {
        m1035a(paint, 16.0f);
    }

    /* renamed from: a */
    public void m1035a(Paint paint, float f) {
        ...
        if (this.f6274dA) {
            this.f6113bO.mo213a(c1029m.f6595b);
        }
    }

    /* renamed from: h */
    public void m956h(String str) {
        m1025a(str, true);
    }

    /* renamed from: a */
    public void m1025a(String str, boolean z) {
        this.f6280dH = str;
        if (this.f6279dG != null) {
            this.f6279dG.mo108a(str, z);
        }
    }
    ...
    /* renamed from: i */
    public void m954i(String str) {
        m1030a(str, 1);
    }

    /* renamed from: a */
    public void m1030a(String str, int i) {
        if (f6205aU) {
            LogDebug2("alert:" + str);
        } else if (str == null) {
            m958g("Cannot show alert, no message text");
        } else {
            this.f6172dD = str;
            this.f6276dC.m5370a(this.f6277a);
        }
        if (this.f6279dG != null) {
            this.f6279dG.mo110a(str, i);
        }
    }

    /* renamed from: Z */
    public boolean m1047Z() {
        if (this.f6279dG != null) {
            return this.f6279dG.mo104c();
        }
        return false;
    }

    /* renamed from: a */
    public void m1029a(String str, C0385az c0385az) {
        String str2 = null;
        if (c0385az != null) {
            str2 = c0385az.m4038b();
        }
    ...
    /* renamed from: c */
    public void m975c(String str, String str2) {
        if (this.f6279dG != null) {
            this.f6279dG.mo109a(str, str2);
        }
        if (f6205aU) {
            if (this.f6279dG == null) {
                m983b("showMessageBox: not showing due to non-android:" + str2);
                return;
            }
            return;
        }
        ...
        this.f6173dE = str;
        this.f6174dF = str2;
        this.f6276dC.m5370a(this.f6278b);
    }
    ...
    public void m1015aa() {
        synchronized (this.f6281dI) {
            if (this.f6175dJ != null) {
                m975c(this.f6176dK, this.f6175dJ);
                this.f6175dJ = null;
                this.f6176dK = null;
            }
        }
    ...
    /* renamed from: d */
    public void m968d(String str, String str2) {
        this.f6176dK = str;
        this.f6175dJ = str2;
        if (f6207aW) {
            m1015aa();
    ...
    /* renamed from: ab */
    public boolean m1014ab() {
        if (this.f6081aq || this.f6079ao.mo240k() == null) {
            return false;
        }
        return this.f6079ao.mo240k().m5161b();
    }

    /* renamed from: ac */
    public void m1013ac() {
        if (this.f6079ao.mo240k() == null) {
            return;
        }
        this.f6079ao.mo240k().m5160c();
    }
    ...
    public int m1012ad() {
        ...
        return this.f6079ao.mo240k().m5164a();
    }

    /* renamed from: ae */
    public float m1011ae() {
        return m987b(0);
    }

    /* renamed from: af */
    public float m1010af() {
        return m979c(0);
    }

    /* renamed from: b */
    public float m987b(int i) {
        if (this.settingEngine.renderDoubleScale) {
            return this.f6079ao.mo240k().m5159d()[i] / 2.0f;
        }
        return this.f6079ao.mo240k().m5159d()[i];
    }

    /* renamed from: c */
    public float m979c(int i) {
        if (this.settingEngine.renderDoubleScale) {
            return this.f6079ao.mo240k().m5157f()[i] / 2.0f;
        }
        return this.f6079ao.mo240k().m5157f()[i];
    }

    /* renamed from: d */
    public int m971d(int i) {
        return this.f6079ao.mo240k().m5158e()[i];
    }

    /* renamed from: e */
    public boolean m965e(int i) {
        if (i != 1 && i != 2 && i != 3) {
    ...
    /* renamed from: f */
    public int m962f(int i) {
        if (i == 0) {
            throw new RuntimeException("finding state of 0 doesn't make sense");
        }
        int[] m5158e = this.f6079ao.mo240k().m5158e();
        for (int i2 = 0; i2 < m5158e.length; i2++) {
            if (m5158e[i2] == i) {
                return i2;
            }
        }
    ...
    /* renamed from: a */
    public boolean m1041a(int i, boolean z) {
        boolean z2 = true;
        boolean z3 = true;
        int m1009ag = m1009ag();
        if ((i & 2) != 0) {
    ...
    /* renamed from: j */
    public static String m953j(int i) {
        String str = VariableScope.nullOrMissingString;
        if ((i & 2) != 0) {
            str = str + "shift+";
        }
    ...
    public int m1009ag() {
        int i = 0;
        if (m957h(59) || m957h(60)) {
            i = 0 + 2;
        }
        if (m957h(113) || m957h(114)) {
            i++;
        }
        if (m957h(57) || m957h(58)) {
            i += 4;
        }
        return i;
    }
    ...
    /* renamed from: c */
    public boolean m978c(int i, int i2) {
        boolean z = false;
        boolean z2 = false;
    ...
    /* renamed from: b */
    public void m985b(int i, boolean z) {
        if (i >= 0 && i < this.f6284c.length) {
            this.f6284c[i] = z;
            if (z) {
                this.f6285d[i] = z;
            ...
            if (c1060p != null) {
                if (c1060p instanceof C1062r) {
                    ...
                    if (c1062r.f6737c >= this.f6284c.length || c1062r.f6737c < 0) {
                        m982b("updateKeyState", "keyCode (" + c1062r.f6737c + ") is out of range");
                    } else {
    ...
    /* renamed from: j */
    public static String m952j(String str) {
    ...
    /* renamed from: k */
    public static String m949k(String str) {
        int i;
        int lastIndexOf = str.lastIndexOf("/");
        if (lastIndexOf == -1) {
            i = 0;
    ...
    /* renamed from: l */
    public static Integer m947l(String str) {
        String m949k = m949k(str);
        LogDebug2("getMapLevel for :" + str + " file:" + m949k);
        Matcher matcher = Pattern.compile("^l(\\d*);.*").matcher(m949k);
        if (matcher.matches()) {
    ...
    /* renamed from: m */
    public static String m945m(String str) {
        Core m1072A = m1072A();
        Integer m947l = m947l(str);
        if (m947l == null) {
            return null;
        }
        int lastIndexOf = str.lastIndexOf("/");
        ...
        String[] m2236a = C0750a.m2236a(substring, true);
        if (m2236a == null) {
            return null;
        }
        for (String str2 : m2236a) {
            Integer m947l2 = m947l(str2);
            if (m947l2 != null && m947l2.intValue() > m947l.intValue() && (!m1072A.f6228ar || ActivityC0117i.m5174a(str2, substring + "/" + str2))) {
    ...
    /* renamed from: aj */
    public String m1006aj() {
        return this.f6165dk;
    }

    /* renamed from: ak */
    public String m1005ak() {
        String str = this.f6165dk;
        if ((this.f6165dk == null || VariableScope.nullOrMissingString.equals(this.f6165dk)) && m1060M()) {
            str = this.f6122bX.m1432l();
        }
        return ActivityC0117i.m5171e(ActivityC0117i.m5172d(str));
    }

    /* renamed from: al */
    public String m1004al() {
        return ActivityC0117i.m5172d(this.f6165dk);
    }

    /* renamed from: am */
    public EnumC0846ai m1003am() {
        if (ActivityC0117i.m5169g(this.f6165dk)) {
    ...
    /* renamed from: a */
    public static String m1024a(Throwable th) {
    ...
    /* renamed from: b */
    public static String m981b(Throwable th) {
        String replace;
        Throwable th2;
    ...
    /* renamed from: an */
    public static File m1002an() {
        C0750a.m2226d();
        String str = "/SD/rustedWarfare/crashes.txt";
        if (m997as()) {
            str = "/SD/rustedWarfare/crashes.txt";
        }
        return new File(C0750a.m2223e(str));
    }

    /* renamed from: e */
    public static void m963e(String str, String str2) {
        try {
            PrintWriter printWriter = new PrintWriter(C0750a.m2240a(m1002an(), true));
    ...
    /* renamed from: ao */
    public static void m1001ao() {
        if (!f6191at || f6205aU) {
            return;
        }
        if (f6179dR != null) {
            m983b("setupANRWatchDog: activeANRWatchDog!=null");
            return;
        }
        f6179dR = new C1087d(4000);
        f6179dR.m564a(new InterfaceC1091e() { // from class: com.corrodinggames.rts.gameFramework.l.4
            @Override // com.corrodinggames.rts.gameFramework.utility.InterfaceC1091e
            /* renamed from: a */
            public void mo563a(C1066a c1066a) {
                if (Core.f6222dS) {
                    Core.m983b("activeANRWatchDog: ANR already detected");
                }
                Core.f6222dS = true;
                Core.m983b("activeANRWatchDog: ANR detected");
                String m1024a = Core.m1024a(c1066a);
                C0879n.m1260a("detectedANR", m1024a);
                try {
                    Thread.sleep(400L);
                } catch (InterruptedException e) {
                    e.printStackTrace();
                ...
                try {
                    FileOutputStream fileOutputStream = new FileOutputStream(C1122y.m424a("lastFreeze", VariableScope.nullOrMissingString, true));
                    PrintStream printStream = new PrintStream(fileOutputStream);
                    printStream.print(m1024a);
                    printStream.close();
        ...
        f6179dR.start();
        m983b("setupANRWatchDog: running");
    }

    /* renamed from: ap */
    public static void m1000ap() {
        if (f6178dO == null && m995au()) {
    ...
    /* renamed from: aq */
    public boolean m999aq() {
        return true;
    }

    /* renamed from: ar */
    public boolean m998ar() {
        return true;
    }

    /* renamed from: n */
    public static void m944n(String str) {
        Core m1072A = m1072A();
        if (m1072A != null) {
            f6223dT++;
            if (f6223dT < 1000) {
                m983b("reportProblem: " + str);
            }
            if (f6223dT < 10) {
                m1072A.m1030a(str, 1);
            }
    ...
    /* renamed from: as */
    public static boolean m997as() {
        return !f6205aU;
    }

    /* renamed from: at */
    public static boolean m996at() {
        return !f6207aW || f6210aZ;
    }

    /* renamed from: au */
    public static boolean m995au() {
        return f6207aW && !f6210aZ;
    }

    /* renamed from: av */
    public static boolean m994av() {
        return f6207aW && !f6210aZ;
    }

    /* renamed from: aw */
    public static boolean m993aw() {
        return f6205aU && !f6207aW;
    }

    /* renamed from: ax */
    public boolean m992ax() {
        return this.f6122bX.lock1 || this.f6126cb.m2411h();
    }

    /* renamed from: a */
    public void m1034a(AbstractC0244am abstractC0244am, float f) {
        this.f6121bW.m1741a((int) abstractC0244am.f6957el, (int) abstractC0244am.f6958em, f, abstractC0244am);
        this.f6117bS.f5116f.m1897c(abstractC0244am);
    }

    /* renamed from: ay */
    public static boolean m991ay() {
        Core m1072A = m1072A();
        if (m1072A != null && m1072A.settingEngine.teamShaders && (m1072A.settingEngine.newRender || !m997as())) {
            return true;
        }
        return f6200aN;
    }
    ...
    /* renamed from: az */
    public static boolean m990az() {
        Core m1072A = m1072A();
        if (m1072A != null && m1072A.settingEngine.shaderEffects && (m1072A.settingEngine.newRender || !m997as())) {
            return true;
        }
        return f6199aM;
    }
    ...
    /* renamed from: aC */
    public Context m1018aC() {
        return this.f6227am;
    }

    /* renamed from: f */
    public static void m960f(String str, String str2) {
        Core m1072A = m1072A();
        if (m1072A == null) {
            return;
        }
        if (m1072A.f6117bS != null && m1072A.f6117bS.f5115e != null) {
            m1072A.f6117bS.f5115e.m1750a(str, str2);
        } else {
            m958g("addMessage: interfaceEngine/messageInterface==null");
        }
    }

    /* renamed from: a */
    public static void m1033a(EnumC1065u enumC1065u, Throwable th) {
        f6220dP = null;
    ...
    /* renamed from: c */
    public static void m974c(Throwable th) {
        try {
            th.printStackTrace();
        } catch (Throwable th2) {
    ...
    public void m1017aD() {
        if (f6181dW && !f6182dX) {
            ...
            int m1654h = this.f6124bZ.m1654h();
            if (m1654h > 1) {
                str = str + "This is often caused by large mods, you currently have: " + m1654h + " mods loaded. ";
            }
            m975c("Warning: Low memory detected", str);
        }
        if (!f6180dU && f6224dV != null) {
            ...
            int m1654h2 = this.f6124bZ.m1654h();
            if (m1654h2 > 1) {
                str3 = str3 + "This is often caused by large mods, you currently have: " + m1654h2 + " mods. ";
            }
            if (m995au() && !C0191i.f1218b) {
                str3 = str3 + "You are also using the 32 bit version, switching to the 64 bit version might help. ";
            }
            m975c("Warning: Out Of Memory", str3);
        }
    }
    ...
    /* renamed from: a */
    public void m1032a(Runnable runnable) {
        this.f6289eb.m730a(runnable);
    }

    /* renamed from: a */
    public final boolean m1044a(float f, float f2, float f3) {
        return this.f6249cL.f234a < f + f3 && f - f3 < this.f6249cL.f236c && this.f6249cL.f235b < f2 + f3 && f2 - f3 < this.f6249cL.f237d;
    }

    /* renamed from: o */
    public static boolean m942o(String str) {
        if (f6203aQ == null) {
            return false;
        }
    ...
    /* renamed from: p */
    public static void m941p(String str) {
        C0831ad c0831ad = m1072A().f6122bX;
