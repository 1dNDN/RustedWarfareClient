...
public final class C1109s extends AbstractList implements Serializable, Cloneable, RandomAccess {
    ...
    /* renamed from: a */
    public static final AbstractC1120w[] f6913a = new AbstractC1120w[0];

    /* renamed from: b */
    int f6914b;

    /* renamed from: c */
    transient AbstractC1120w[] f6915c = f6913a;
    ...
    /* renamed from: f */
    public static /* synthetic */ int m500f(C1109s c1109s) {
    ...
    /* renamed from: a */
    public AbstractC1120w[] m514a() {
        return this.f6915c;
    }

    @Override // java.util.AbstractList, java.util.AbstractCollection, java.util.Collection, java.util.List
    /* renamed from: a */
    public boolean add(AbstractC1120w abstractC1120w) {
        AbstractC1120w[] abstractC1120wArr = this.f6915c;
        int i = this.f6914b;
        if (i == abstractC1120wArr.length) {
            ...
            this.f6915c = abstractC1120wArr2;
        }
    ...
    /* renamed from: a */
    public void add(int i, AbstractC1120w abstractC1120w) {
        AbstractC1120w[] abstractC1120wArr = this.f6915c;
        int i2 = this.f6914b;
        if (i > i2 || i < 0) {
            m512a(i, i2);
        ...
        if (i2 < abstractC1120wArr.length) {
            ...
            AbstractC1120w[] abstractC1120wArr2 = new AbstractC1120w[m504c(i2)];
            System.arraycopy(abstractC1120wArr, 0, abstractC1120wArr2, 0, i);
    ...
    /* renamed from: c */
    private static int m504c(int i) {
        return i + (i < 6 ? 12 : i >> 1);
    }
    ...
    public boolean addAll(Collection collection) {
        ...
        AbstractC1120w[] abstractC1120wArr2 = this.f6915c;
        int i = this.f6914b;
        int i2 = i + length;
        if (i2 > abstractC1120wArr2.length) {
            AbstractC1120w[] abstractC1120wArr3 = new AbstractC1120w[m504c(i2 - 1)];
            System.arraycopy(abstractC1120wArr2, 0, abstractC1120wArr3, 0, i);
            abstractC1120wArr2 = abstractC1120wArr3;
            this.f6915c = abstractC1120wArr3;
        }
    ...
    public boolean addAll(int i, Collection collection) {
        ...
        if (i3 <= abstractC1120wArr2.length) {
            ...
            AbstractC1120w[] abstractC1120wArr3 = new AbstractC1120w[m504c(i3 - 1)];
            System.arraycopy(abstractC1120wArr2, 0, abstractC1120wArr3, 0, i);
    ...
    /* renamed from: a */
    static IndexOutOfBoundsException m512a(int i, int i2) {
    ...
    public void clear() {
        if (this.f6914b != 0) {
            Arrays.fill(this.f6915c, 0, this.f6914b, (Object) null);
            this.f6914b = 0;
            this.modCount++;
        }
    }
    ...
    public Object clone() {
        try {
            ...
            c1109s.f6915c = (AbstractC1120w[]) this.f6915c.clone();
            return c1109s;
    ...
    @Override // java.util.AbstractList, java.util.List
    /* renamed from: a */
    public AbstractC1120w get(int i) {
        if (i >= this.f6914b) {
            m512a(i, this.f6914b);
        }
    ...
    public int lastIndexOf(Object obj) {
        ...
        for (int i2 = this.f6914b - 1; i2 >= 0; i2--) {
    ...
    @Override // java.util.AbstractList, java.util.List
    /* renamed from: b */
    public AbstractC1120w remove(int i) {
        AbstractC1120w[] abstractC1120wArr = this.f6915c;
        int i2 = this.f6914b;
        if (i >= i2) {
            m512a(i, i2);
    ...
    protected void removeRange(int i, int i2) {
        ...
        int i3 = this.f6914b;
        if (i >= i3) {
            throw new IndexOutOfBoundsException("fromIndex " + i + " >= size " + this.f6914b);
        }
        if (i2 > i3) {
            throw new IndexOutOfBoundsException("toIndex " + i2 + " > size " + this.f6914b);
        }
        if (i > i2) {
    ...
    @Override // java.util.AbstractList, java.util.List
    /* renamed from: b */
    public AbstractC1120w set(int i, AbstractC1120w abstractC1120w) {
        AbstractC1120w[] abstractC1120wArr = this.f6915c;
        if (i >= this.f6914b) {
            m512a(i, this.f6914b);
        }
    ...
    public Object[] toArray() {
        ...
        System.arraycopy(this.f6915c, 0, objArr, 0, i);
        return objArr;
    }
