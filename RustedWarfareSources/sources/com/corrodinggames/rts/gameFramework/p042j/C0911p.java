...
public final class C0911p {
    ...
    /* renamed from: a */
    public final C0911p m1088a(short s, short s2) {
        this.f6074a = s;
        this.f6075b = s2;
        return this;
    }
    ...
    /* renamed from: a */
    public final C0911p m1089a(C0911p c0911p) {
    ...
    /* renamed from: a */
    public final C0911p m1097a(C0909n c0909n) {
    ...
    /* renamed from: a */
    public final int m1096a(RunnableC0910o runnableC0910o) {
        short s = this.f6074a;
    ...
    /* renamed from: a */
    public final int m1095a(RunnableC0910o runnableC0910o, byte b) {
        return runnableC0910o.f6057l[b][(this.f6074a * runnableC0910o.f6053h) + this.f6075b];
    }

    /* renamed from: a */
    public final void m1092a(RunnableC0910o runnableC0910o, byte b, int i) {
        runnableC0910o.f6057l[b][(this.f6074a * runnableC0910o.f6053h) + this.f6075b] = i;
    }

    /* renamed from: a */
    public final void m1090a(RunnableC0910o runnableC0910o, byte b, boolean z) {
        if (z) {
    ...
    /* renamed from: b */
    public final boolean m1087b(RunnableC0910o runnableC0910o, byte b) {
    ...
    /* renamed from: c */
    public final byte m1085c(RunnableC0910o runnableC0910o, byte b) {
        return (byte) (runnableC0910o.f6058m[b][(this.f6074a * runnableC0910o.f6053h) + this.f6075b] & 7);
    }

    /* renamed from: d */
    public final boolean m1084d(RunnableC0910o runnableC0910o, byte b) {
        return (runnableC0910o.f6058m[b][(this.f6074a * runnableC0910o.f6053h) + this.f6075b] & 8) != 0;
    }

    /* renamed from: b */
    public final void m1086b(RunnableC0910o runnableC0910o, byte b, boolean z) {
        if (z) {
            byte[] bArr = runnableC0910o.f6058m[b];
            int i = (this.f6074a * runnableC0910o.f6053h) + this.f6075b;
    ...
    /* renamed from: a */
    public final void m1094a(RunnableC0910o runnableC0910o, byte b, byte b2) {
        byte[] bArr = runnableC0910o.f6058m[b];
        int i = (this.f6074a * runnableC0910o.f6053h) + this.f6075b;
        bArr[i] = (byte) (bArr[i] & (-16));
        byte[] bArr2 = runnableC0910o.f6058m[b];
    ...
    /* renamed from: a */
    public final void m1093a(RunnableC0910o runnableC0910o, byte b, float f) {
        ...
        if (i < 0 || i > 7) {
            AbstractC0916l.m963e("setCurrentDirectionFromAngle: dir:" + i + " direction:" + f);
            i = 0;
        }
        m1094a(runnableC0910o, b, (byte) i);
    }

    /* renamed from: e */
    public final boolean m1083e(RunnableC0910o runnableC0910o, byte b) {
    ...
    /* renamed from: f */
    public final C0911p m1082f(RunnableC0910o runnableC0910o, byte b) {
        C0911p c0911p = new C0911p();
        if (m1091a(runnableC0910o, b, c0911p)) {
            return c0911p;
        }
        return null;
    }
    ...
    /* renamed from: a */
    public final boolean m1091a(RunnableC0910o runnableC0910o, byte b, C0911p c0911p) {
        if (!m1083e(runnableC0910o, b)) {
            c0911p.m1088a((short) -1, (short) -1);
            return false;
        }
        byte m1085c = m1085c(runnableC0910o, b);
        if (m1084d(runnableC0910o, b)) {
            c0911p.m1088a((short) -1, (short) -1);
            return false;
        }
        int i = 0;
        ...
        c0911p.m1088a((short) (this.f6074a - i), (short) (this.f6075b - i2));
        return true;
    }
}
