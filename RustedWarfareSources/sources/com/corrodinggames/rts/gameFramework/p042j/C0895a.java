...
public final class C0895a extends AbstractList implements Serializable, Cloneable, RandomAccess {
    ...
    /* renamed from: a */
    public static final C0909n[] f5911a = new C0909n[0];

    /* renamed from: b */
    public int f5912b;

    /* renamed from: c */
    transient C0909n[] f5913c;

    /* renamed from: a */
    public static /* synthetic */ int m1222a(C0895a c0895a) {
        return c0895a.modCount;
    }

    /* renamed from: b */
    public static /* synthetic */ int m1217b(C0895a c0895a) {
        return c0895a.modCount;
    }

    /* renamed from: c */
    public static /* synthetic */ int m1214c(C0895a c0895a) {
        return c0895a.modCount;
    }

    /* renamed from: d */
    public static /* synthetic */ int m1213d(C0895a c0895a) {
    ...
    public C0895a(int i) {
        ...
        this.f5913c = i == 0 ? f5911a : new C0909n[i];
    }
    ...
    /* renamed from: b */
    public void m1216b(C0909n c0909n) {
        C0909n[] c0909nArr = this.f5913c;
        int i = this.f5912b;
        if (i == c0909nArr.length) {
            C0909n[] c0909nArr2 = new C0909n[i + (i < 6 ? 12 : i >> 1)];
    ...
    public void add(int i, C0909n c0909n) {
        ...
        if (i2 < c0909nArr.length) {
            ...
            C0909n[] c0909nArr2 = new C0909n[m1215c(i2)];
            System.arraycopy(c0909nArr, 0, c0909nArr2, 0, i);
    ...
    /* renamed from: c */
    private static int m1215c(int i) {
        return i + (i < 6 ? 12 : i >> 1);
    }
    ...
    public boolean addAll(Collection collection) {
        ...
        C0909n[] c0909nArr2 = this.f5913c;
        int i = this.f5912b;
        int i2 = i + length;
        if (i2 > c0909nArr2.length) {
            C0909n[] c0909nArr3 = new C0909n[m1215c(i2 - 1)];
            System.arraycopy(c0909nArr2, 0, c0909nArr3, 0, i);
            c0909nArr2 = c0909nArr3;
            this.f5913c = c0909nArr3;
        }
    ...
    public boolean addAll(int i, Collection collection) {
        ...
        if (i3 <= c0909nArr2.length) {
            ...
            C0909n[] c0909nArr3 = new C0909n[m1215c(i3 - 1)];
            System.arraycopy(c0909nArr2, 0, c0909nArr3, 0, i);
    ...
    /* renamed from: a */
    static IndexOutOfBoundsException m1224a(int i, int i2) {
    ...
    public void clear() {
        if (this.f5912b != 0) {
            Arrays.fill(this.f5913c, 0, this.f5912b, (Object) null);
            this.f5912b = 0;
            this.modCount++;
        }
    }
    ...
    public Object clone() {
        try {
            ...
            c0895a.f5913c = (C0909n[]) this.f5913c.clone();
            return c0895a;
    ...
    public int lastIndexOf(Object obj) {
        ...
        for (int i2 = this.f5912b - 1; i2 >= 0; i2--) {
    ...
    protected void removeRange(int i, int i2) {
        ...
        int i3 = this.f5912b;
        if (i >= i3) {
            throw new IndexOutOfBoundsException("fromIndex " + i + " >= size " + this.f5912b);
        }
        if (i2 > i3) {
            throw new IndexOutOfBoundsException("toIndex " + i2 + " > size " + this.f5912b);
        }
        if (i > i2) {
    ...
    public Object[] toArray() {
        ...
        System.arraycopy(this.f5913c, 0, objArr, 0, i);
        return objArr;
    }
