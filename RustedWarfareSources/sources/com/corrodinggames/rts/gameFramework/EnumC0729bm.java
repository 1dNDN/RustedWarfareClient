...
public enum EnumC0729bm {
    total { // from class: com.corrodinggames.rts.gameFramework.bm.1
    },
    update { // from class: com.corrodinggames.rts.gameFramework.bm.2
    },
    draw { // from class: com.corrodinggames.rts.gameFramework.bm.3
    },
    draw_game { // from class: com.corrodinggames.rts.gameFramework.bm.4
    },
    draw_end,
    draw_gui,
    draw_game_effects,
