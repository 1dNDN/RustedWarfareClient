...
public final class C0402bc {
    ...
    /* renamed from: a */
    public static C0402bc m4181a(C0453l c0453l, C1072ab c1072ab) {
        C0402bc c0402bc = new C0402bc();
        c0402bc.m4177b(c0453l, c1072ab);
        ...
        while (it.hasNext()) {
            ...
            if (c0448g != null) {
                ...
                if (i == 1) {
                    c0453l.m3665r("[placementRule_" + c0404be.f2498a + "]anyRuleInGroup: No other rule with this same group name found");
                }
            }
        }
        return c0402bc;
    ...
    /* renamed from: b */
    public void m4177b(C0453l c0453l, C1072ab c1072ab) {
        Iterator it = c1072ab.m644e("placementRule_").iterator();
        while (it.hasNext()) {
            String str = (String) it.next();
            String substring = str.substring("placementRule_".length());
            C0404be c0404be = new C0404be();
            c0404be.f2498a = substring;
            c0404be.m4174a(c0453l, c1072ab, str);
            if (c0404be.m4175a()) {
    ...
    /* renamed from: a */
    public String m4180a(AbstractC0623y abstractC0623y, float f, float f2) {
        if (!this.f2491c) {
            return null;
        }
        return m4176b(abstractC0623y, f, f2);
    }

    /* renamed from: a */
    public String m4179a(AbstractC0623y abstractC0623y, int i, int i2) {
        if (!this.f2492d) {
            return null;
        }
        C0173b c0173b = Core.m1087A().f6110bL;
        c0173b.m5306b(i, i2);
        return m4176b(abstractC0623y, c0173b.f801T, c0173b.f802U);
    }

    /* renamed from: b */
    public String m4176b(AbstractC0623y abstractC0623y, float f, float f2) {
        boolean z;
        ...
        while (it.hasNext()) {
            ...
            while (it2.hasNext()) {
                ...
                if (c0404be2.f2499b == c0448g && c0404be2.f2511n) {
                    if (!m4178a(abstractC0623y, c0404be2, f, f2)) {
                        if (c0404be == null) {
                            c0404be = c0404be2;
                        }
                        z3 = true;
    ...
    /* renamed from: a */
    private static boolean m4178a(AbstractC0623y abstractC0623y, C0404be c0404be, float f, float f2) {
        f2493e.f2494a = f + c0404be.f2504g;
        f2493e.f2495b = f2 + c0404be.f2505h;
        f2493e.f2496c = c0404be;
        f2493e.f2497d = 0;
        Core.m1087A().f6127cc.m3258a(f2493e.f2494a, f2493e.f2495b, c0404be.f2502e, abstractC0623y, 0.0f, f2493e);
