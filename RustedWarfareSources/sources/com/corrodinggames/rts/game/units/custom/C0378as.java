...
public class C0378as extends VariableScope.CachedWriter.WriterFactory {
    ...
    public VariableScope.CachedWriter.WriterElement createWriterElement(String str, String str2, String str3) {
        ...
        try {
            LogicBoolean parseBooleanBlock = LogicBooleanLoader.parseBooleanBlock(this.f2258a, str3, false);
            AbstractC0377ar abstractC0377ar = (AbstractC0377ar) C0359aq.f2254q.get(str);
            if (abstractC0377ar == null) {
                abstractC0377ar = (AbstractC0377ar) C0359aq.f2254q.get("core." + str);
            }
            if (abstractC0377ar == null) {
                throw new C0412bm("Unknown key: " + str + VariableScope.nullOrMissingString);
            }
            C0379at c0379at = new C0379at();
            c0379at.f2259a = abstractC0377ar;
            c0379at.f2260b = parseBooleanBlock;
            c0379at.f2261c = operator;
            if (parseBooleanBlock.getReturnType() != abstractC0377ar.m3848a()) {
                throw new C0412bm("Field: " + str + " expects " + abstractC0377ar.m3848a() + " type getting: " + parseBooleanBlock.getReturnType() + " from: " + str3);
            }
            return c0379at;
