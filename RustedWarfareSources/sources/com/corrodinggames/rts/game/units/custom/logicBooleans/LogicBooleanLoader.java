...
public class LogicBooleanLoader {
    ...
    public static LogicBoolean parseBooleanBlock(C0453l c0453l, String str, boolean z) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            if (C0758f.m2066c(lowerCase, str2)) {
                boolean z3 = false;
                boolean z4 = false;
                ...
                if (str2.equals("<>")) {
                    int m2113a = C0758f.m2113a(breakOuterLayerBrackets, 0, strArr);
                    m2107a = new ArrayList();
                    m2107a.add(breakOuterLayerBrackets.substring(0, m2113a));
                    int i3 = m2113a + 2;
                    if (i3 > breakOuterLayerBrackets.length() - 1) {
                        i3 = breakOuterLayerBrackets.length() - 1;
                    }
                    String substring = breakOuterLayerBrackets.substring(m2113a, i3);
                    if (!substring.endsWith("=")) {
                        substring = substring.substring(0, 1);
                    }
                    m2107a.add(breakOuterLayerBrackets.substring(m2113a + substring.length()));
                    str2 = substring;
                } else if (z4) {
                    m2107a = C0758f.m2107a(breakOuterLayerBrackets, str2, z3, true);
                } else {
                    m2107a = C0758f.m2107a(breakOuterLayerBrackets, str2, z3, false);
                }
                if (m2107a.size() == 1) {
                    continue;
                } else if (str2.equals("=")) {
                    ...
                    if (!((String) m2107a.get(0)).equals(VariableScope.nullOrMissingString) || m2107a.size() != 2 || (!str2.equals("+") && !str2.equals("-"))) {
                        ArrayList arrayList = new ArrayList();
                        ...
                        if (requireBooleanChildren && ((newJoiner instanceof CompareJoinerBoolean.CompareNotEqualBoolean) || (newJoiner instanceof CompareJoinerBoolean.CompareEqualBoolean))) {
                            AbstractC0916l.m963e(newJoiner.type() + " was set to require boolean. Workaround triggered. requireBooleanChildren:" + newJoiner.requireBooleanChildren());
                            requireBooleanChildren = false;
                        }
                        int i4 = -1;
                        if (str2.equals("+") || str2.equals("-")) {
                            boolean z5 = false;
                            Iterator it = m2107a.iterator();
                            while (true) {
                                if (it.hasNext()) {
        ...
        if (breakOuterLayerBrackets.length() > 0) {
            ...
            String m2012x = C0758f.m2012x(str6);
            if (C0758f.m2015u(m2012x)) {
                if (z) {
                    throw new RuntimeException("Expected a boolean type here, not number: " + m2012x);
                }
                return LogicBoolean.StaticValueBoolean.getStaticNumber(m2012x);
            }
            String m2020p = C0758f.m2020p(breakOuterLayerBrackets);
            if (m2020p != null) {
                if (z) {
                    throw new RuntimeException("Expected a boolean type here, not string: " + breakOuterLayerBrackets);
                }
                return new LogicString.StaticString(m2020p);
            }
        }
        boolean z6 = false;
        boolean z7 = false;
        ...
        int i5 = 0;
        while (i5 < m2108a.length) {
            String str8 = m2108a[i5];
        ...
        for (int i6 = c1101m.f6894a - 1; i6 >= 0; i6--) {
    ...
    public static void setArgumentsWithMapping(ParameterMapping parameterMapping, Object obj, String str, C0453l c0453l, String str2) {
        ...
        if (str != null && !VariableScope.nullOrMissingString.equals(str)) {
            int i = 0;
            boolean z = false;
            Iterator it = C0758f.m2079b(str, ",", false).iterator();
            while (it.hasNext()) {
                String str5 = (String) it.next();
                int m2056d = C0758f.m2056d(str5, "=");
                if (m2056d > 0) {
                    str3 = str5.substring(0, m2056d);
                    str4 = str5.substring(m2056d + 1);
                    z = true;
                } else if (z) {
    ...
    public static Object getArgumentTextWithMapping(ParameterMapping.FieldOrMethod fieldOrMethod, Object obj) {
        if (fieldOrMethod != null && fieldOrMethod.field != null) {
            ...
            AbstractC0916l.m963e("getArgumentTextWithMapping: method not supported");
            return "<method>";
        } else {
            AbstractC0916l.m963e("getArgumentTextWithMapping: No method or field");
            return "<error>";
        }
    }
    ...
    public static Object convertParameterData(String str, Class cls, C0453l c0453l, LogicBoolean.ReturnType returnType, String str2) {
        ...
        if (cls == LogicBoolean.class) {
            ...
            return parseBooleanBlock;
        } else if (C0758f.m2014v(trim)) {
            if (!C0758f.m2066c(trim, ".")) {
                if (cls == String.class) {
                    return trim;
                }
            ...
            if (match != null) {
                return C0758f.m2019q(match.group(1));
            }
            Matcher match2 = match(patternDoubleQuote, trim);
            if (match2 != null) {
                return C0758f.m2019q(match2.group(1));
            }
    ...
    public abstract class LogicBooleanContextWithDefault implements LogicBooleanContext {
        ...
        public static LogicBoolean defaultParseNextElementInChain(LogicBooleanContext logicBooleanContext, String str, C0453l c0453l, String str2, boolean z, String str3, String str4) {
            ...
            if (logicBoolean != null) {
                ...
                return logicBoolean.with(c0453l, fixArguments, lowerCase).validateAndOptimize(lowerCase, fixArguments, str3, logicBooleanContext, z);
            } else if (str4 != null) {
