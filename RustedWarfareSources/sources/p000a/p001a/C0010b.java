...
public class C0010b extends ServerSocket {
    ...
    public C0010b(int i, int i2, InetAddress inetAddress, boolean z) {
        ...
        m5281a(datagramSocket, i2);
    }

    public C0010b(DatagramSocket datagramSocket, int i) {
        m5281a(datagramSocket, i);
    }

    /* renamed from: a */
    public void m5281a(DatagramSocket datagramSocket, int i) {
    ...
    /* renamed from: a */
    public void m5283a(AbstractC0012c abstractC0012c) {
    ...
    /* renamed from: a */
    public void m5279a(SocketAddress socketAddress, C0014e c0014e) {
        synchronized (this.f34i) {
            c0014e.m5264a(this.f39l);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: a */
    public C0014e m5280a(SocketAddress socketAddress) {
        C0014e c0014e;
        synchronized (this.f34i) {
