...
public class RunnableC0009i implements Runnable {
    ...
    */
    public void run() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p000a.p001a.p002a.RunnableC0009i.run():void");
    }

    /* renamed from: a */
    public synchronized void m5294a(long j) {
        m5293a(j, 0L);
    }

    /* renamed from: a */
    public synchronized void m5293a(long j, long j2) {
        this.f21d = j;
        this.f22e = j2;
        if (this.f24g) {
    ...
    /* renamed from: b */
    public synchronized boolean m5292b() {
        return this.f24g;
    }

    /* renamed from: c */
    public synchronized boolean m5291c() {
        return !m5292b();
    }

    /* renamed from: d */
    public synchronized void m5290d() {
        synchronized (this.f27j) {
            this.f25h = true;
            this.f27j.notify();
        }
    ...
    /* renamed from: e */
    public synchronized void m5289e() {
        this.f24g = false;
        synchronized (this.f27j) {
            this.f23f = true;
            this.f27j.notify();
    ...
    /* renamed from: f */
    public synchronized void m5288f() {
        m5289e();
        this.f26i = true;
        notify();
    }
